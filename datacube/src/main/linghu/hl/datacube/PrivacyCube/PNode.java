...
import main.linghu.hl.datacube.api.tree.SharedLinkMap;
...
public class PNode implements IContent {
    ...
    protected IContent content = null;      // 指向下一个分类开始点PNode；若本身为最后一个，则为TableCuboid
    ...
    public PNode addChildNode(PNode childNode, boolean shared) {
        if (_children == null)
